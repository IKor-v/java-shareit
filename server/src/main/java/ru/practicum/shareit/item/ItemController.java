...
public class ItemController {
    ...
    @PostMapping
    public ItemDtoIn addItem(@RequestHeader(headerUserId) long userId,
                             @Validated(CreateInfo.class) @RequestBody ItemDtoIn itemDtoIn) throws ValidationException {
    ...
    public CommentDtoIn addComment(@RequestHeader(headerUserId) long userId,
                                   @PathVariable long itemId, @Validated @RequestBody CommentDtoIn commentDto) {
